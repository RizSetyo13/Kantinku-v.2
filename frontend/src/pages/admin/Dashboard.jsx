...
import { Users, Store, ShoppingBag, DollarSign, AlertTriangle, MapPin, FileText, ArrowRight } from 'lucide-react';
      ...
      <div className="with-sidebar main-content">
        ...
        {stats?.pendingKedai > 0 && (
          <div style={{ background: 'rgba(245,158,11,0.1)', border: '1px solid rgba(245,158,11,0.3)', borderRadius: 'var(--radius-md)', padding: '1rem 1.25rem', marginBottom: '2rem', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <a href="/admin/kedai" style={{ marginLeft: 'auto', color: 'var(--warning)', fontSize: '0.85rem', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
          ...
          <div className="card">
            <div className="card-header">
              <div className="card-title">
                <MapPin size={18} style={{marginRight:'8px', color:'var(--primary)'}} />
