...
import { Layers, GraduationCap, Store, UserPlus } from 'lucide-react';
        ...
        <div className="card">
          ...
          <div className="form-group">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
              {[
                { value: 'customer', icon: <GraduationCap size={28} />, label: 'Mahasiswa', desc: 'Pesan makanan' },
                { value: 'merchant', icon: <Store size={28} />, label: 'Pemilik Kedai', desc: 'Jual makanan' },
              ].map(r => (
                <div
                  key={r.value}
                ...
                >
                  <div style={{ color: form.role === r.value ? 'var(--primary)' : 'var(--text-muted)', marginBottom: '0.35rem', display: 'flex', justifyContent: 'center' }}>{r.icon}</div>
