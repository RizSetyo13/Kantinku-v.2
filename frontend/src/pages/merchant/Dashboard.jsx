...
import { FileText, Calendar, DollarSign, Package, ArrowRight } from 'lucide-react';
        ...
        <div className="grid-4" style={{ marginBottom: '2rem' }}>
          <div className="stat-card">
            ...
            <div className="stat-info">
              ...
              <div className="stat-sub">pesanan</div>
            </div>
          </div>
          <div className="stat-card">
          ...
          <div className="stat-card">
            ...
            <div className="stat-info">
              ...
              <div className="stat-value" style={{ fontSize: '1.2rem' }}>Rp {parseInt(stats?.revenue || 0).toLocaleString('id')}</div>
            </div>
          </div>
        </div>
        ...
        <div className="card">
          <div className="card-header">
            <div className="card-title">
              <FileText size={18} style={{marginRight:'8px', color:'var(--primary)'}} />
              Pesanan Terbaru
            </div>
            <a href="/merchant/orders" style={{ fontSize: '0.85rem', color: 'var(--primary)', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
              Lihat Semua <ArrowRight size={14} />
            </a>
          </div>
          {orders.length === 0 ? (
            <div className="empty-state" style={{ padding: '2rem' }}>
              <div className="empty-icon" style={{ opacity: 0.3 }}><Package size={48} /></div>
